...
namespace aspnetcoregraphql
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.Authority = "https://testapp-et.eu.auth0.com/";
                options.Audience = "http://localhost:60756/";
            });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseCors(builder =>
                builder.WithOrigins(new string[] {"http://localhost:60756", "http://localhost:8080"})
                    .AllowAnyHeader()
                    .AllowAnyMethod()
            );
            app.UseMvc();
